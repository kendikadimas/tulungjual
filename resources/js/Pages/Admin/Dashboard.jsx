...
export default function Dashboard({ stats = {}, recentListings = [] }) {
    ...
    return (
        <AdminLayout title="Overview">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm col-span-2 md:col-span-1 lg:col-span-2">
